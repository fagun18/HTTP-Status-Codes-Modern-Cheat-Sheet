...
export const statusCodes: StatusCode[] = [
    ...
    { code: 103, title: 'Early Hints', description: 'Used to return some response headers before final HTTP message.', category: 'Informational' },
    ...
    { code: 425, title: 'Too Early', description: 'Indicates that the server is unwilling to risk processing a request that might be replayed.', category: 'Client Error' },
    ...
    { code: 509, title: 'Bandwidth Limit Exceeded', description: 'The server bandwidth limit has been exceeded.', category: 'Unofficial', isUnofficial: true },
    ...
    // Unofficial / Custom
    { code: 521, title: 'Web Server Is Down', description: 'The web server is down. Used by Cloudflare.', category: 'Unofficial', isUnofficial: true },
    { code: 522, title: 'Connection Timed Out', description: 'Cloudflare could not negotiate a TCP handshake with the origin server.', category: 'Unofficial', isUnofficial: true },
    { code: 523, title: 'Origin Is Unreachable', description: 'Cloudflare could not reach the origin server; for example, if the DNS records for the origin server are incorrect.', category: 'Unofficial', isUnofficial: true },
    { code: 525, title: 'SSL Handshake Failed', description: 'Cloudflare could not negotiate a SSL/TLS handshake with the origin server.', category: 'Unofficial', isUnofficial: true },
    { code: 529, title: 'Site is Overloaded', description: 'The service is overloaded. Used by Qualys.', category: 'Unofficial', isUnofficial: true },
    { code: 530, title: 'Site is Frozen', description: 'The site has been frozen. Used by Pantheon.', category: 'Unofficial', isUnofficial: true },
    { code: 598, title: 'Network Read Timeout Error', description: 'Used by some HTTP proxies to signal a network read timeout behind the proxy.', category: 'Unofficial', isUnofficial: true },
];
